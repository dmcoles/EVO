-> Simple example of integer buttons V0.11 © by DMX 2001
  ...
  MODULE 'dos/dos','exec/ports','intuition/intuition','intuition/gadgetclass','intuition/imageclass',
       'gadgets/layout','gadgets/integer','images/bevel','images/label','utility/tagitem',
       'classes/window','window','layout','integer','label','button','bevel','reaction/reaction_macros','amigalib/lists','amigalib/boopsi'
...
->    PrintF('appPort = 0x\z\h[8]\n', appPort) -> Debug
    objects[OID_MAIN]:=WindowObject,
      ...
      WINDOW_PARENTGROUP, gmain := VGroupObject,
        ...
        LAYOUT_SHRINKWRAP, TRUE,
          ...
          LAYOUT_ADDCHILD, gint1 := IntegerObject,
            GA_ID, GID_INTEGER1,
            GA_RELVERIFY, TRUE,
            GA_GADGETHELP, TRUE,
            GA_TABCYCLE, TRUE,
          ...
          LAYOUT_ADDCHILD, gint2 := IntegerObject,
            GA_ID, GID_INTEGER2,
            GA_RELVERIFY, TRUE,
            GA_GADGETHELP, TRUE,
            GA_TABCYCLE, TRUE,
    ...
    gadgets[GID_INTEGER1]:=gint1
    gadgets[GID_INTEGER2]:=gint2
...
PROC openAll()
  ...
  IF (integerbase := OpenLibrary('gadgets/integer.gadget', 44))=NIL; PrintF('Can''t open integer.gadget\n'); closeAll(13); ENDIF
